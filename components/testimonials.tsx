...
const REVIEWS: Review[] = [
  {
    ...
    text:
      "Спасибо ребятам с компании, мне везде отказывало, а они мне оформили сумму на 1 млн тенге! Большая благодарность",
  },
  {
    name: "Гулжан",
    text:
      "Қызымет көрсеттуі маған үнады жылдам әрі тез Олжас жұмысымды біттіріп берді",
  },
  {
    name: "Aruzhan Yesp.",
    text:
      "Спасибо менеджерам, помогли родителям решить вопрос",
  },
  {
    name: "Eldos Moldagaliyev",
    text:
      "Огромное спасибо менеджерам! Всё грамотно и чётко отработано. И самое главное — уважение к клиентам.",
  },
  {
    name: "Sanim Saruarova",
    text:
      "Спасибо менеджерам. Всё чётко отработали. Быстро и удобно. Советую всем!",
  },
  {
    name: "Asemgul",
    text:
  ...
  },
  {
    ...
    text:
      "Помогли оформить кредит на выгодных условиях, одобрили в короткие сроки. Вежливые и профессиональные сотрудники, всё объяснили и сопровождали до конца. Сервис на уровне — работают на результат. Спасибо команде Prime Capital! Рекомендую!",
  },
];
